...
void (*ApplyPerkModifiers)(uint32_t entryPointID, TESObjectREFR* perkOwner, void* arg3, ...) = (void(*)(uint32_t, TESObjectREFR*, void*, ...))0x5E58F0;
...
Tile* (__cdecl* GetMenuTile)(uint32_t id) = (Tile * (__cdecl*)(uint32_t))0xA09030;
...
float(__cdecl* ScaleArmorDTDRByCondition)(uint16_t dtDR, float condition) = (float(__cdecl*)(uint16_t, float))0x646360;
...
void* (*NiAllocator)(uint32_t size) = (void* (*)(uint32_t))0xAA13E0;
...
{
	static const uint32_t procAddr = kAddr_GetItemHealthPerc;
	__asm	jmp		procAddr
}
...
namespace Radio
{
	...
	bool GetEnabled() { return *(uint8_t*)0x11DD434; }
