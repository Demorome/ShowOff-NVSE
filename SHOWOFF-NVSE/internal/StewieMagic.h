...
extern void (*ApplyPerkModifiers)(uint32_t entryPointID, TESObjectREFR* perkOwner, void* arg3, ...);
...
extern Tile* (__cdecl* GetMenuTile)(uint32_t id);
...
extern float(__cdecl* ScaleArmorDTDRByCondition)(uint16_t dtDR, float condition);
...
extern void* (*NiAllocator)(uint32_t size);
