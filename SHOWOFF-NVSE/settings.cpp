...
void HandleINIOptions()
{
	...
	if (errVal == SI_Error::SI_FILE)
	{
		if (GetModuleHandle(MO2_VFS_DLL_NAME))
		{
			...
			MessageBoxA(NULL, R"(ShowOff INI not found, please download it or create an empty file ShowOff_nvse.ini in 'Data\NVSE\Plugins\' !)", "ShowOff NVSE", MB_ICONINFORMATION);
			return;
		}
	}
