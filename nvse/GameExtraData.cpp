...
EquipDataSet FindEquippedItems(ExtraContainerChanges* contChanges, uint32_t const filterFlags)
{
...
const char *GetExtraDataName(uint8_t extraDataType)
{
...
// Copied from JIP
__declspec(naked) float __vectorcall ExtraContainerChanges::EntryData::GetWeaponModEffectValue(uint32_t effectType) const
{
	__asm
	{
		push	edx
